...
const Errors = require("../errors/skolenie-main-error.js");
...
class SkolenieMainModel {

  constructor() {
    this.validator = new Validator(Path.join(__dirname, "..", "validation_types", "skolenie-main-types.js"));
  }
...
module.exports = new SkolenieMainModel();
